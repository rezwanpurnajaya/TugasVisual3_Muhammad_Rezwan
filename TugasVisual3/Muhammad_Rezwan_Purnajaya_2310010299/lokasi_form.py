...
class LokasiForm(QWidget):
    PK = "id_lokasi"
    def __init__(self, parent=None):
        super().__init__(parent)
        self.w = _load_ui("LokasiForm.ui"); self.w.setParent(self)
        self.w.setWindowTitle("Lokasi (Sederhana)")
    ...
    def on_save(self):
        ...
        try:
            if not pk:
                new_id = crud.lokasi_insert(data)
                ...
                rows = crud.lokasi_update(pk, data)
